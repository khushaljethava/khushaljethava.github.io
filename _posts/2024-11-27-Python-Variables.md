...
| software \= "Python"print(Software) |
| :---- |
...
| X \= "Python" \# X is a StringY \= 2        \# Y is an IntegerZ \= 3.14     \# Z is a floatprint(X)print(Y)print(Z) |
| :---- |
|  |
...
| x , y , z \=  10, 11, 12print(x)print(y)print(z) |
| :---- |
...
| x ,y, z  \= 2021 , 3.7  , "Python"print(x)print(y)print(z) |
| :---- |
...
| 1x \= 2\_x1 \= "Pycharm"\_1 \= 11 |
| :---- |

Output

| File "\<string\>", line 1    1x \= 2     ^SyntaxError: invalid syntax |
| :---- |
...
| X \= 3 \# This both are different x \=  "Python"print(X)print(x) |
| :---- |
...
| X \= "Python"del Xprint(X) |
| :---- |

Output 

| Traceback (most recent call last):  File "Del\_Keyword.py", line 4, in \<module\>    print(X)NameError: name 'X' is not defined |
| :---- |
...
| X \= 1Y \= 3.7Z \= "Python"print(type(X))print(type(Y))print(type(Z)) |
| :---- |
